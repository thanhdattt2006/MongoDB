...
export class Demo3Controller{
    ...
    @Get('index3/:a/:b')
    index3(@Param("a",ParseFloatPipe) a:number, @Param("b",ParseFloatPipe) b:number) {
        return {
    ...
    @Get('area/:a/:b')
    area(@Param("a",ParseFloatPipe) a:number, @Param("b",ParseFloatPipe) b:number) {
        return {
    ...
    @Get('perimeter/:a/:b')
    perimeter(@Param("a",ParseFloatPipe) a:number, @Param("b",ParseFloatPipe) b:number) {
        return {
